...
<div class="page-header">
    <h1>Oops! <small>Something horrible happened!</small></h1>
</div>

<div class="alert alert-danger">
    <p>
        <strong>Frak!</strong>
        It's look like there is some bugs in there! Fortunately only you (administrator) can see this page. 
    </p>
    <p>
        <i>If it's a real bug, go ahead and fix it!</i>
    </p>
</div>
...
// Unique error identifier
    ...
    ?>
    <style type="text/css">
        #kohana_error { background: #ddd; font-size: 1em; text-align: left; color: #111; }
        #kohana_error h1,
